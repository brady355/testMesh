...
/opt/offlinemesh/sources/rust-teos.tar.gz               bundled TEOS/watchtower source
/opt/offlinemesh/sources/protoc-27.3-linux-aarch_64.zip bundled protoc
/opt/offlinemesh/sources/rust-1.81.0-aarch64-unknown-linux-gnu.tar.xz bundled Rust
```

During testing, Ethernet can be used for GitHub clones and apt. For final node behavior, the nodes should use only the gateway after mesh setup.
